...
import me.theminebench.exgame.game.eventgame.game.lobbygame.listeners.spectate.SpectateManager;
...
public class SpleefListener implements Listener {
	...
	public SpleefListener(SpleefGame spleefGame) {
		this.spleefGame = spleefGame;
		this.lobbyGameManager = spleefGame.getLobbyGameManager();
	...
	@GameEventHandler
	public void createWorld(GameWorldCreater e) {
	...
	@GameEventHandler
	public void onSpectaterManager(SpectateManager e) {
		this.spectateManager = e;
	}
	...
	public void onEntityExplode(EntityExplodeEvent e){
		...
		for (UUID u : getSpectateManager().getGamePlayers()) {
