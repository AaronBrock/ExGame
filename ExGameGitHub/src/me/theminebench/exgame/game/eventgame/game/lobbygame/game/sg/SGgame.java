package me.theminebench.exgame.game.eventgame.game.lobbygame.game.sg;
...
import me.theminebench.exgame.game.eventgame.game.lobbygame.game.sg.listeners.playerdata.PlayerDataManager;
...
public class SGgame implements LobbyGame {
	...
	@Override
	public void setLobbyGameManager(LobbyGameManager lobbyGameManager) {this.lobbyGameManager = lobbyGameManager;}
	...
	public void start() {
		...
		new LMSGameEnder(getLobbyGameManager());
		
		new PlayerDataManager(getLobbyGameManager());
